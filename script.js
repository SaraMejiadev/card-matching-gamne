class AudioController {
    constructor() {
        this.bgMusic = new Audio('audio/FIFTY FIFTY - Cupid (Sped Up) (Twin Version) (Lyrics).mp3');
        ...
        this.gameOverSound = new Audio('audio/GAME OVER CUTE VOICE - Gaming Sound Effects HD FREE NO Copyright (1).mp3');
